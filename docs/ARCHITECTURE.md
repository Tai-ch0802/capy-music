...
> 文件版本 v0.14 — 2026-09-22(Apple 寫入研究與 R-8 真帳號探測:§1.2 表、§9 P0-2 ✅、附錄 C 決策 49 取代 30 的 append-only 預期;計畫 docs/superpowers/plans/2026-09-22-apple-write.md)
> 前版 v0.13 — 2026-09-18(P8 網頁介面面向一般使用者:§9 P8、附錄 C 決策 45–48;計畫在 docs/superpowers/plans/2026-09-18-web-consumer.md,視覺規格 v2 在 2026-09-18-web-consumer-design.md)
